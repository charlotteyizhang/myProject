...
var browserSync = require('browser-sync');
 let fs = require('fs'),
    PDFParser = require("pdf-to-text");
    
    let inputStream = fs.createReadStream("./dist/test.pdf", {bufferSize: 64 * 1024});
    let outputStream = fs.createWriteStream("./dist/output.txt");
